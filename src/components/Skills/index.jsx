...
import img from '../../assets/SVG/image.4d343154196987f5278b842c29d87c37.svg'
...
const Skilss = () => {
   return (
      <section className="flex flex-col items-center justify-center w-full h-screen md:flex-row">
         ...
         <div className="px-10">
            <h4 className="font-sans dark:text-gray ">What Is My Skills ?</h4>
            ...
            <div className="relative grid grid-cols-7 mt-5 right-6 text-center-center">
               <div className="flex flex-col justify-center items-center text-gray dark:text-light hover:text-primary dark:hover:text-[#635AEB]">
               ...
               <div className="mx-3 flex flex-col justify-center items-center text-gray dark:text-light hover:text-primary dark:hover:text-[#635AEB]">
